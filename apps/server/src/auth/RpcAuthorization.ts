...
export const RPC_REQUIRED_SCOPES = {
  [WS_METHODS.workAutomationsControl]: AuthOrchestrationOperateScope,
  [WS_METHODS.workAutomationsList]: AuthOrchestrationReadScope,
  [WS_METHODS.workAutomationsSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.workAutomationsMutate]: AuthOrchestrationOperateScope,
  [WS_METHODS.workDashboardList]: AuthOrchestrationReadScope,
  [WS_METHODS.workDashboardSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.workActivityList]: AuthOrchestrationReadScope,
  [WS_METHODS.workActivitySubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.slackGet]: AuthOrchestrationReadScope,
  [WS_METHODS.slackList]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.githubIssuesSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.githubIssuesMutate]: AuthOrchestrationOperateScope,
  [WS_METHODS.notificationsList]: AuthOrchestrationReadScope,
  [WS_METHODS.notificationsSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.notificationsMutate]: AuthOrchestrationOperateScope,
  [WS_METHODS.workReviewsGet]: AuthOrchestrationReadScope,
  [WS_METHODS.workReviewsSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.workReviewsMutate]: AuthOrchestrationOperateScope,
  [WS_METHODS.workPullRequestsGet]: AuthOrchestrationReadScope,
  [WS_METHODS.workPullRequestsSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.workPullRequestsMutate]: AuthOrchestrationOperateScope,
  [WS_METHODS.workExecutionsGet]: AuthOrchestrationReadScope,
  [WS_METHODS.workExecutionsSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.workExecutionsMutate]: AuthOrchestrationOperateScope,
  [WS_METHODS.workPlansGet]: AuthOrchestrationReadScope,
  [WS_METHODS.workPlansSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.workPlansMutate]: AuthOrchestrationOperateScope,
  [WS_METHODS.workItemsList]: AuthOrchestrationReadScope,
  [WS_METHODS.workItemsGet]: AuthOrchestrationReadScope,
  [WS_METHODS.workItemsSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.workItemsMutate]: AuthOrchestrationOperateScope,
  [WS_METHODS.workItemsDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.workTaskUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.vercelRead]: AuthOrchestrationReadScope,
  [WS_METHODS.vercelProjects]: AuthOrchestrationReadScope,
  [WS_METHODS.vercelAdmin]: AuthAccessWriteScope,
  [WS_METHODS.vercelLink]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.sourceControlExistingRepository]: AuthOrchestrationReadScope,
  [WS_METHODS.sourceControlCloneRepository]: AuthOrchestrationOperateScope,
  [WS_METHODS.sourceControlPublishBranch]: AuthOrchestrationOperateScope,
